...
public interface AnalyticsService {
     ...
     * <p>
     * The summary covers the full calendar month specified by {@code year} and
     * {@code month}
     * (from the first day to the last day, inclusive). Categories with no
     * transactions in the
     * month are still included with a total of {@code 0}.
     *
     * @param year  the calendar year (e.g., 2026)
     * @param month the calendar month (1-12)
     * @return a list of category summaries for the month (one entry per
     *         {@link Category})
